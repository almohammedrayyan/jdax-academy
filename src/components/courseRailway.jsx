...
const railwaySections = [
  {
    ...
    content: [
      "Preliminary exam syllabus and preparation tips",
      "Mains exam structure and strategy",
      "Computer-based test practice",
      "General Awareness, Reasoning, Maths, and English focus",
    ],
  },
  {
    title: "→ RRB Group D",
    content: [
      "Physical Efficiency Test (PET) overview",
      "Written exam syllabus and preparation",
      "Document verification process",
      "Tips for excelling in PET and written exam",
    ],
  },
];

export default function CourseRailway() {
    ...
    <div className="bg-white text-gray-800 min-h-screen">
      ...
      <section className="relative bg-gradient-to-r from-[#0d1117] to-[#431aa0] text-yellow-400 py-16 px-6 text-center mt-2">
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-gray-200">
          Focused coaching for RRB NTPC and Group D exams with comprehensive
      ...
      <section className="py-16 px-6 md:px-20 grid md:grid-cols-2 gap-10">
        ...
        <div className="space-y-4">
          {railwaySections.map((section, index) => (
            <motion.div
              key={index}
        ...
        >
          ...
          <div className="p-6">
            ...
            <p className="text-gray-700 mb-4">
              Expert coaching for RRB NTPC and Group D exams with tailored study
