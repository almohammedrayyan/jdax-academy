...
const metadata = {
  title: "GROUP 2 & 2A Prelims PYQ Papers (2021-2025) - TNPSC",
  description:
    "Download GROUP 2 & 2A Prelims Previous Year Question Papers from 2021 to 2025 for TNPSC preparation.",
};
...
function getDownloadLink(year) {
  return `https://drive.google.com/file/d/YOUR_TNPSC_GROUP2_PRELIMS_${year}_FILE_ID/view`;
}

export default function Group2PrelimsPYQPage() {
  return (
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                GROUP 2 & 2A Prelims PYQs
              </h1>
              <p className="text-lg text-slate-600 mt-2">
                Non-Interview Posts - Preliminary Examination
              </p>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="space-y-4">
            {years.map((item, index) => (
              <div
                key={index}
                className="bg-white rounded-xl shadow-lg border-2 border-slate-200 hover:border-blue-400 transition-all duration-300"
              >
                <div className="p-6">
