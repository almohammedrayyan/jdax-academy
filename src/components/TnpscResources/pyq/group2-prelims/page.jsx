...
function YearAccordion({ item }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border-2 border-slate-200 hover:border-blue-400 transition-all duration-300 overflow-hidden">
      <button
          ...
          <div className="pt-4 grid sm:grid-cols-2 gap-3">
            {item.papers.map((paper, i) => (
              <a
                ...
                className="flex items-center justify-between gap-3 px-4 py-3 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg transition-all duration-200 group"
              >
