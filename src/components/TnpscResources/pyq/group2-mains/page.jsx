...
const metadata = {
  ...
  description:
    "Download GROUP 2 & 2A Mains Previous Year Question Papers from 2021 to 2025 for TNPSC preparation.",
};
...
function getDownloadLink(year) {
  return `https://drive.google.com/file/d/YOUR_TNPSC_GROUP2_MAINS_${year}_FILE_ID/view`;
}
