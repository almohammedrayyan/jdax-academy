    ...
    papers: [
      {
        ...
        link: "https://drive.google.com/file/d/1n_djkvXx51XrFKYUmn5ij8NFgRewS2G5//view",
      },
    ],
  },
  {
    ...
    papers: [
      {
        label: "General Studies",
        link: "https://drive.google.com/file/d/1NnH8lEx8HEVbJwRg-an9gvrRvBaGvbpo/view",
      },
    ],
  },
  {
    ...
    papers: [
      {
        label: "General Studies",
        link: "https://drive.google.com/file/d/1HfBF2gHQw7miICJZYdaG5Spc09lJ6KNw/view",
      },
    ],
  },
  {
    ...
    papers: [
      {
        label: "General Studies",
        link: "https://drive.google.com/file/d/1LbIgDq-oMw1iWgz275jMBUkXRip1h93g/view",
      },
    ],
  },
];
...
export default function Group1PrelimsPYQPage() {
  return (
      ...
      <section className="relative py-16 px-4 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-600 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-4 h-4 rotate-[-90deg]" />
            <span className="text-slate-900 font-medium">GROUP 1 Prelims</span>
          </div>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
                GROUP 1 Prelims PYQs
              </h1>
              <p className="text-lg text-slate-600 mt-2">
                Combined Civil Services - Preliminary Examination
              </p>
            </div>
          </div>
