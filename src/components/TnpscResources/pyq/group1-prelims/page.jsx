      ...
      <section className="relative py-16 px-4 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-600 mb-6 flex-wrap">
            <Link to="/resource/tnpsc-page" className="hover:text-emerald-600 transition-colors">
              TNPSC Resources
            </Link>
            <ChevronDown className="w-4 h-4 rotate-[-90deg]" />
            <Link to="/resource/tnpsc-pyq" className="hover:text-emerald-600 transition-colors">
              PYQ Papers
            </Link>
            <ChevronDown className="w-4 h-4 rotate-[-90deg]" />
