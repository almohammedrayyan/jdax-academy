...
const metadata = {
  title: "GROUP 1 Prelims PYQ Papers (2021-2025) - TNPSC",
  description:
    "Download GROUP 1 Prelims Previous Year Question Papers from 2021 to 2025 for TNPSC preparation.",
};
...
function getDownloadLink(year) {
  return `https://drive.google.com/file/d/YOUR_TNPSC_GROUP1_PRELIMS_${year}_FILE_ID/view`;
}
